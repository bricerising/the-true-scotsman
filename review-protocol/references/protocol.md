...
- `resilience`: `apply-resilience-patterns`
- `testing` / `correctness`: `consumer-test-coverage`
- `maintainability`: `typescript-style-guide`
- `architecture`: `select-architecture-pattern`, `select-design-pattern`
- `api-design`: `spec-driven-development`, `shared-platform-library`
- `performance`: `apply-observability-patterns` (measure + verify)

...
- Deeper checklists by review type (optional, this repo):
  - `security`: [`apply-security-patterns`](../apply-security-patterns/SKILL.md)
  - `resilience`: [`apply-resilience-patterns`](../apply-resilience-patterns/SKILL.md)
  - `testing` / `correctness`: [`consumer-test-coverage`](../consumer-test-coverage/SKILL.md)
  - `maintainability`: [`typescript-style-guide`](../typescript-style-guide/SKILL.md)
  - `architecture`: [`select-architecture-pattern`](../select-architecture-pattern/SKILL.md), [`select-design-pattern`](../select-design-pattern/SKILL.md)
  - `api-design`: [`spec-driven-development`](../spec-driven-development/SKILL.md), [`shared-platform-library`](../shared-platform-library/SKILL.md)
  - `performance`: [`apply-observability-patterns`](../apply-observability-patterns/SKILL.md) (measure + verify)
